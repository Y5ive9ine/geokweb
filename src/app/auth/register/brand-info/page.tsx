          ...
          <div className="hidden lg:flex items-center mb-16 max-w-6xl">
            ...
            <div className="flex items-center">
              <div className="w-[30px] h-[30px] bg-[#CCCCCC] rounded-full flex items-center justify-center">
                <span className="text-[#666666] text-[18px] font-normal">1</span>
              </div>
              <span className="ml-4 text-[#CCCCCC] text-[18px] font-normal whitespace-nowrap">开始</span>
            </div>
            ...
            <div className="flex items-center">
              ...
              <span className="ml-4 text-[#333333] text-[18px] font-semibold whitespace-nowrap">填写您的品牌详细信息</span>
            </div>
          ...
          <div className="lg:hidden flex justify-center items-center mb-16 -ml-4">
            <div className="flex items-center space-x-4">
              <div className="flex flex-col items-center">
                <div className="w-[30px] h-[30px] bg-[#CCCCCC] rounded-full flex items-center justify-center">
                  <span className="text-[#666666] text-[16px] font-normal">1</span>
                </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-[#333333] text-sm font-semibold text-center">品牌<br/>信息</span>
              </div>
          ...
          <div className="space-y-[91px] mb-16 max-w-[540px]">
            ...
            <div>
              <div className="flex items-center mb-[18px]">
                ...
                <span className="ml-2 text-[14px] text-[#CCCCCC] cursor-help" title="请输入您的品牌名称">
            ...
            <div>
              <div className="flex items-center mb-[18px]">
                ...
                <span className="ml-2 text-[14px] text-[#CCCCCC] cursor-help" title="请输入您的品牌官方域名">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor">
                    <path d="M7 0C3.14 0 0 3.14 0 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7zm0 11.2c-.44 0-.8-.36-.8-.8s.36-.8.8-.8.8.36.8.8-.36.8-.8.8zm1-3.6c0 .55-.45 1-1 1s-1-.45-1-1V6c0-.55.45-1 1-1s1 .45 1 1v1.6z"/>
                  </svg>
                </span>
            ...
            <div>
              <div className="flex items-center mb-[18px]">
                ...
                <span className="ml-2 text-[14px] text-[#CCCCCC] cursor-help" title="请输入您要监控的关键词">
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor">
                    <path d="M7 0C3.14 0 0 3.14 0 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7zm0 11.2c-.44 0-.8-.36-.8-.8s.36-.8.8-.8.8.36.8.8-.36.8-.8.8zm1-3.6c0 .55-.45 1-1 1s-1-.45-1-1V6c0-.55.45-1 1-1s1 .45 1 1v1.6z"/>
                  </svg>
                </span>
            ...
            <div className="relative">
              ...
              {verificationStatus === VerificationStatus.VERIFYING && (
                <div className="flex items-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-[6px] rounded shadow-lg">
                  ...
                  <span className="text-[16px] font-normal leading-[44px]">验证中</span>
                </div>
              )}
              ...
              {verificationStatus === VerificationStatus.SUCCESS && (
                <div className="flex items-center bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-[6px] rounded shadow-lg animate-pulse">
                  ...
                  <span className="text-[16px] font-normal leading-[44px]">验证成功</span>
                </div>
              )}
            </div>
          </div>
