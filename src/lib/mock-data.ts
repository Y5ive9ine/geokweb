...
export const mockAISearches: AISearch[] = [
  {
    id: 'search-1',
    brand_id: 'brand-1',
    questions: ['What are the best processors for gaming?', 'Which CPU brand is most reliable?'],
    status: 'completed',
...
export const mockAIResponses: AIResponse[] = [
  {
    ...
    response: 'For gaming, Intel and AMD both offer excellent processors. Intel\'s latest 13th gen processors provide great performance, while AMD\'s Ryzen series offers excellent value for money.',
    model_type: 'gpt-4',
